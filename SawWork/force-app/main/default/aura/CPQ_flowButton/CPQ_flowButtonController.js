({
    ...
    init: function (component, event, helper) {
        ...
        console.log('FlowButtonController > init - buttonLabel: ' + buttonLabel + ', launchFlowOnInit: ' + launchFlowOnInit);
    ...
    handleNavigation: function (component, event, helper) {
        ...
        if (flowToLaunch) {
            ...
            console.log('FlowButtonController > handleNavigation - button clicked: ' + buttonLabel
            ...
            console.log('FlowButtonController > handleNavigation - button not configured to do anything');
        }
    ...
    handleStatusChange: function (component, event, helper) {
        ...
        console.log('FlowButtonController > handleStatusChange - status: ' + component.get("v.flowStatus"));
        ...
        if (status == "FINISHED") {
            ...
            var showFlowInModal = component.get("v.showFlowInModal");
            console.log('FlowButtonController > handleStatusChange - showFlowInModal: ' + showFlowInModal);
            if (showFlowInModal) {
                helper.closeModal(component);
            }

            var doAction = component.get("v.doFlowActionWhenSubflowCompletes");
            console.log('FlowButtonController > handleStatusChange - doFlowActionWhenSubflowCompletes: ' + doAction);
