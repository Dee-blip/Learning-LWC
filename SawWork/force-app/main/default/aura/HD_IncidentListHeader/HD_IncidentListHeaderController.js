({
	doInit : function(cmp, event, helper) {
        ...
        /*if(localStorage.getItem("incType")==null)
        {
             localStorage.setItem("incType","Incident");
        }
...
$A.enqueueAction(action);
    ...
    onViewChange: function(cmp, evt, helper) {
       ...
       localStorage.setItem("incType",ticketType)
    ...
    showCreateForm : function(component,event,helper){
       ...
       component.find("newIncident").showModal();
    ...
    handleLocationChange: function( cmp, evt, h ) {
    ...
    goToEditListView: function(component,event,helper){
        ...
        var fileterId = component.get("v.filterId");
        var url = "/ui/list/FilterEditPage?id=" + encodeURIComponent(fileterId);
        window.open(url,'_blank');

    },

    handleComponentError: function(component, event, helper){
        let toastMessage = event.getParam('toast');
        let errorMessage = event.getParam('error');

        HD_Error_Logger.createLogger(component,event,helper,toastMessage,errorMessage,true);
    }
