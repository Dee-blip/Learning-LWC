/* ========================================================================
    ...
    ======================================================================== */
trigger EntitledProductDRTrigger on EB_Product__c  (after insert, after update) 
{   
    ...
    { 
        ...
        {
            ExternalSharingHelper.CaptureRecordUpdate('EB_Product__c', Trigger.newMap.keyset());
        }
    }
}