/* ========================================================================
    ...
    ======================================================================== */
trigger CaseUpdateHistoryDRTrigger on Case_Update_History__c (after insert, after update)
{
   if(!ExternalSharingHelper.isTriggerFutureControl && (!system.Test.isRunningTest() || (system.Test.isRunningTest() && ExternalSharingHelper.RunFromtestClass == true)))
    {
        ...
        {
            ExternalSharingHelper.CaptureRecordUpdate('Case_Update_History__c', Trigger.newMap.keyset());
        }
    }
}