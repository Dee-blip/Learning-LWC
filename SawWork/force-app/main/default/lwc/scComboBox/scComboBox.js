...
export default class ComboBox extends LightningElement {
    ...
    @api placeholder;
    @api options;
    defaultoptionsjarvis2;
    @api required;

    @api
    get defaultoptionsjarvis() {
        return this.defaultoptionsjarvis2;
    }
    set defaultoptionsjarvis(valueoption) {
        if(!this.defaultoptionsjarvis2 && valueoption && valueoption.length > 0) {
                this.defaultoptionsjarvis2 = valueoption;       
        }
    }
   ...
   get processedListData() {
    ...
    get noresults() {
        ...
        return this.searchStr && this.noResultsMsg && (!this.processedListData || this.processedListData.length === 0);
    }
...
//            if(x) {
                ...
                if(!this.searchStr && this.defaultoptionsjarvis2)
                {
                    /* eslint-disable */
                    this.options = this.defaultoptionsjarvis2.slice();
                    /* eslint-enable */
                }
//            }
        }
